...
#include "drv_usb.h"
<<<<<<< HEAD:src/main/config/profile.c
...
CBOR_START_STRUCT_ENCODER(profile_stick_calibration_limits_t)
...
CBOR_START_STRUCT_DECODER(profile_stick_calibration_limits_t)
CALIBRATION_LIMIT_MEMBERS
CBOR_END_STRUCT_DECODER()
